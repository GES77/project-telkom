...
@section('container')
    {{-- MODAL START --}}
    <div class="modal fade" id="modalKontrak" aria-hidden="true" aria-labelledby="modalKontrakLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background-color: white;">
                <div class="modal-header">
                    <div class="container d-flex ">
                        <h5 class="modal-title " id="modalKontrakLabel">Kontrak</h5>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <form action="{{-- /insertPemasukan --}}" method="{{-- POST --}}" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="kontrak" class="form-control inputmid" placeholder="Nama File"
                                    style="width: 400px;">
                            </div>
                            ...
                            <div class="footerTambahKontrak d-flex justify-content-between align-items-center">
                                <br>
    ...
    <div class="d-flex justify-content-center align-items-center ">
        <div class="container">
            <div class="row mt-5 mb-3">
                <div class="col-lg-12">
                    <h3 class="text-halo"><b>Kontrak</b></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center"
                            ...
                            <a class="add-user" data-bs-toggle="modal" href="#modalKontrak" role="button">
                        ...
                        <div class="card-body ">
                            <div class="table-responsive">
                                <table class="table table-bordered hover border text-nowrap mb-0 rounded-table" id="myTable">
                                    <thead>
                                        <tr>
