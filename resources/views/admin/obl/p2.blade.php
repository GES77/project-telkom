...
@section('container')
    {{-- MODAL START --}}
    <div class="modal fade" id="modalP2" aria-hidden="true" aria-labelledby="modalP2Label" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background-color: white;">
                <div class="modal-header">
                    <div class="container d-flex ">
                        <h5 class="modal-title " id="modalP2Label">P2</h5>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <form action="{{-- /insertPemasukan --}}" method="{{-- POST --}}" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="p2" class="form-control inputmid" placeholder="Nama File"
                                    style="width: 400px;">
                            </div>
                            ...
                            <div class="footerTambahP2 d-flex justify-content-between align-items-center">
                                <br>
            ...
            <div class="row mt-5 mb-3">
                {{-- <div class="col-lg-12"> --}}
                    <div class="row d-flex align-items-start flex-start">
                        <h3 class="text-halo"><b>OBL > P2</b></h3>
                    </div>
                {{-- </div> --}}
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center"
                            ...
                            <a class="add-user" data-bs-toggle="modal" href="#modalP2" role="button">
